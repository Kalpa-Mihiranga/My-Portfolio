      ...
      <section className="relative min-h-[92vh] flex flex-col justify-end overflow-hidden">
        ...
        <div className="section-container relative z-10 pb-24 pt-32">
          ...
          <div className="animate-fade-in-up delay-100 flex items-center gap-3 mb-8">
            ...
            <span className="label-mono text-primary">{siteConfig.role.split(" ")[0].toUpperCase()} • Full-Stack • Mobile & Desktop App Developer</span>
          </div>
        ...
        <div className="section-container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-on-surface-variant leading-relaxed mb-10">Specializing in high-performance full-stack architecture. I bridge the gap between complex data systems and intuitive, scalable software.</p>
              ...
              <div className="grid grid-cols-2 gap-6">
                {[
                  ...
                  { label: "03. DataBase", value: skills.data.slice(0, 2).join(", ") },
            ...
            <div className="glass-panel rounded-xl p-6 font-mono text-sm">
              ...
              {[
                { text: "> INITIALIZING_CORE_SERVICES...", color: "text-blue-400" },
                { text: "> CONNECTING_SECURE_STORAGE...", color: "text-amber-400" },
                { text: "> READY_FOR_DEPLOYMENT...", color: "text-emerald-400" },
              ].map((item, index) => (
                <p 
                  key={index} 
                  className={`${item.color} text-xs font-mono tracking-wider opacity-80 animate-pulse`}
...
<section className="py-24 border-t border-white/5">
  <div className="section-container">
    ...
    <div className="text-center mb-14">
      <span className="label-mono text-primary block mb-3">
        Programming Stack
      </span>

      <h2 className="font-sans font-bold text-4xl tracking-tight mb-4">
        Technologies I Work With
      </h2>

      <p className="text-on-surface-variant max-w-2xl mx-auto leading-relaxed">
        Modern technologies powering scalable applications, intelligent systems,
...
<div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-8">
  {[
    ...
    return (
      <div
        key={index}
        className="group flex flex-col items-center justify-center gap-4 p-6 rounded-2xl border border-white/5 bg-surface-container hover:border-primary/30 hover:-translate-y-2 transition-all duration-300"
      >
        <Icon
          size={46}
          style={{ color: tech.color }}
          className="drop-shadow-[0_0_12px_rgba(255,255,255,0.15)] transition-transform duration-300 group-hover:scale-110"
        />

        <span className="font-mono text-xs tracking-widest text-on-surface-variant group-hover:text-white transition-colors">
          {tech.name}
        </span>
      </div>
    );
