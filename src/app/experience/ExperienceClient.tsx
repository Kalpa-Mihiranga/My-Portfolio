            ...
            <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <div className="group relative">
                ...
                <motion.div
                  ...
                  className="relative aspect-square overflow-hidden rounded-xl border border-white/10 bg-surface-container"
                >
                  <img
                    src="about.jpg"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:h-[560px]">
            ...
            {/* Frontend — wide */}
                <motion.div
                  ...
                  viewport={{ once: true }}
                  whileHover={{ y: -6 }}
                  className="md:col-span-2 glass-panel rounded-xl p-8 flex flex-col justify-between hover:border-white/15 transition-all duration-300"
                >              <div>
            ...
            <div className="md:col-span-1 md:row-span-2 glass-panel rounded-xl p-8 flex flex-col justify-between hover:border-white/15 transition-all duration-300">
              <div className="space-y-4">
                ...
                <h3 className="font-sans font-semibold text-xl">Back-End</h3>
                <p className="text-on-surface-variant text-sm leading-relaxed">
                  Low-latency API orchestration, real-time telemetry pipelines, and scalable microservices.
                </p>
              </div>
            ...
            <div className="md:col-span-1 md:row-span-1 glass-panel rounded-xl p-8 flex flex-col justify-between hover:border-white/15 transition-all duration-300">
              <h3 className="label-mono text-on-surface-variant">Database</h3>
              <div className="space-y-2">
                {skills.data.slice(0, 3).map((s) => (
            ...
            <div className="md:col-span-2 md:row-span-1 glass-panel rounded-xl p-8 flex items-center justify-between group overflow-hidden hover:border-white/15 transition-all duration-300">
              ...
              <motion.div
                  ...
                  className="opacity-5 group-hover:opacity-15 transition-opacity text-8xl font-mono text-primary select-none"
                >
                ▣
              </motion.div>
            </div>
